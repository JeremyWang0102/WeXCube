...
// mid 滚轮滚动 单位，上为正值，下为负值
void DevHIDMouseMidReport(uint8_t mid)
{
    uint8_t report[4];
    memcpy(report, HIDMouse, sizeof(report));
    report[3] = mid;
